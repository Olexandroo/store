                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
                                <div class="slider-text-inner text-center">
                                    ...
                                    <h2 class="bread"><span><a href="index.php">Home</a></span> <span><a
                                                    href="shop.php">Product</a></span> <span>Shopping Cart</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if (!empty($_SESSION['order'])) {
                        foreach($_SESSION['order'] as $key => $value) {
                            if(isset($_POST['quantity'.$key.''])){
                                $_SESSION['order'][$key]['quantity'] = $_POST['quantity'.$key.''];
                            }
                            $_SESSION['order'][$key]['TotalPrice'] = $_SESSION['order'][$key]['quantity'] * $_SESSION['order'][$key]['Price'];
                            $total += $_SESSION['order'][$key]['TotalPrice'];
                            echo '<div class="product-cart">
							<div class="one-forth">
								<div class="product-img" style="background-image: url('.$_SESSION['order'][$key]['URL'].');">
								</div>
								<div class="display-tc">
									<h3>' .$_SESSION['order'][$key]['Product name'] . '</h3>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<span class="price">$' .$_SESSION['order'][$key]['Price'] . '</span>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<form action="" method="POST">
										<input type="text" name="quantity'.$key.'" class="form-control input-number text-center" value="'.$_SESSION['order'][$key]['quantity'].'" min="1" max="100">
									</form>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<span class="price">$'.$_SESSION['order'][$key]['TotalPrice'].'</span>
								</div>
							</div>
							<div class="one-eight text-center">
								<div class="display-tc">
									<a href="functions/delete.php?id='.$key.'" class="closed"></a>
								</div>
							</div>
						</div>';
                        }
                            ...
                            <div class="col-md-3 col-md-push-1 text-center">
                                <div class="total">
                                    ...
                                    <div class="grand-total">
                                        <p><span><strong>Total:</strong></span> <span>$<?php echo $total?></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-entry">
                        <div class="product-img" style="background-image: url(images/item-5.jpg);">
                            ...
                            <form action="" class="cart" method="GET">
                                <p>
                                    <span class="addtocart"><a href="functions/add.php?id=1"><i
                    ...
                    <div class="product-entry">
                        <div class="product-img" style="background-image: url(images/item-6.jpg);">
                            ...
                            <form action="" method="POST" class="cart" enctype="multipart/form-data">
                                <p>
                                    <span class="addtocart"><a href="functions/add.php?id=2"><i
                                                    class="icon-shopping-cart"></i></a></span>
                                        <span><a href="product-detail.php"><i class="icon-eye"></i></a></span>
                                        <span><a href="#"><i class="icon-heart3"></i></a></span>
                                        <span><a href="add-to-wishlist.php"><i class="icon-bar-chart"></i></a></span>
                ...
                <div class="col-md-3 text-center">
                    <div class="product-entry">
                        <div class="product-img" style="background-image: url(images/item-7.jpg);">
                            ...
                            <form action="" class="cart" method="GET">
                                <p>
                                    <span class="addtocart"><a href="functions/add.php?id=3"><i
                                                    class="icon-shopping-cart"></i></a></span>
                                    <span><a href="product-detail.php"><i class="icon-eye"></i></a></span>
                                    <span><a href="#"><i class="icon-heart3"></i></a></span>
                                    <span><a href="add-to-wishlist.php"><i class="icon-bar-chart"></i></a></span>
                ...
                <div class="col-md-3 text-center">
                    <div class="product-entry">
                        <div class="product-img" style="background-image: url(images/item-8.jpg);">
                            ...
                            <form action="" class="cart" method="GET">
                                <p>
                                    <span class="addtocart"><a href="functions/add.php?id=4"><i
                                                    class="icon-shopping-cart"></i></a></span>
                                    <span><a href="product-detail.php"><i class="icon-eye"></i></a></span>
                                    <span><a href="#"><i class="icon-heart3"></i></a></span>
                                    <span><a href="add-to-wishlist.php"><i class="icon-bar-chart"></i></a></span>
